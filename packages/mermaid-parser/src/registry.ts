import type { ClassIR, FlowchartIR, RequirementIR, SequenceIR, StateIR } from "@gmermaid/ir";
...
export const DIAGRAM_KINDS = ["flowchart", "sequence", "class", "state", "requirement"] as const;
export type DiagramKind = (typeof DIAGRAM_KINDS)[number];

export type AnyIR = FlowchartIR | SequenceIR | ClassIR | StateIR | RequirementIR;
